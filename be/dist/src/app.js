...
const SearchHistoryRouter_1 = __importDefault(require("./routes/SearchHistoryRouter"));
...
class App {
    ...
    middlewares() {
        ...
        this.app.use("/api/search-history", SearchHistoryRouter_1.default);
        this.app.use("/api/search", SearchRouter_1.default);
    }
    routes() {
