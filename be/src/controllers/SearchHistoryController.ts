...
class SearchHistoryController {
  ...
  async saveSearchHistory(req: Request, res: Response): Promise<void> {
    try {
      const { userId, query, processedQuery, resultsJson } =
        req.body as CreateSearchHistory;
   ...
   */
  async getHybridSearchHistory(req: Request, res: Response): Promise<void> {
    try {
      const { userId } = req.params;
      const { limit = 20, offset = 0 } = req.query;
   ...
   */
  async getJaccardSearchHistory(req: Request, res: Response): Promise<void> {
    try {
      const { userId } = req.params;
      const { limit = 20, offset = 0 } = req.query;
   ...
   */
  async getVectorSearchHistory(req: Request, res: Response): Promise<void> {
    try {
      const { userId } = req.params;
      const { limit = 20, offset = 0 } = req.query;
